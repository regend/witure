...
abstract class BaseNodeForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'com_image'                     => new sfWidgetFormInputFileEditable(array('edit_mode' => true, 'with_delete' => false, 'file_src' => ''), array('style' => 'max-width:400px;')),
    ...
    $this->setValidators(array(
      ...
      'com_image'                     => new sfValidatorFile(array('path' => sfConfig::get('sf_upload_dir').'/assets', 'required' => false,'mime_types' => 'web_images')),
      'announcement'                  => new sfValidatorString(array('max_length' => 1000, 'required' => false)),
      'redirect_to'                   => new sfValidatorString(array('max_length' => 255, 'required' => false)),
