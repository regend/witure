...
class NodeForm extends BaseNodeForm
{
  ...
  {
    parent::configure();
    $this->useFields(array('id', 'name', 'gw_id', 'com_image', 'announcement', 'redirect_to', 'description', 'civic_number', 'street_name', 'city', 'province', 'country', 'postal_code', 'public_phone_number',
