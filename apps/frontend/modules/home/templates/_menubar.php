...
<?php if ($sf_user->hasCredential('company') OR $sf_user->hasCredential('admin')) {?>
    <li class="expand"><a href="#"><?php echo __("General"); ?></a>
    <ul class="acitem">
<?php if ($sf_user->hasCredential('company')) {?>
  <li><a href="<?php echo url_for('company/show'); ?>"><?php echo __("Company Info"); ?></a></li>
