...
else if ($this->actionName.$this->viewName == 'faqSuccess')
{
  $templateName = sfConfig::get('symfony.view.'.$this->moduleName.'_'.$this->actionName.'_template', $this->actionName);
  $this->setTemplate($templateName.$this->viewName.$this->getExtension());
}
...
else if ($templateName.$this->viewName == 'indexSuccess')
{
  ...
  {
    $this->setDecoratorTemplate('' == 'home' ? false : 'home'.$this->getExtension());
  }
  $response->addHttpMeta('content-type', 'text/html', false);
  $response->addMeta('title', 'Authpuppy Authentication Server', false, false);
  $response->addMeta('description', 'Authpuppy authentication server for wifidog wireless networks', false, false);
...
else if ($templateName.$this->viewName == 'faqSuccess')
{
  if (null !== $layout = sfConfig::get('symfony.view.'.$this->moduleName.'_'.$this->actionName.'_layout'))
  {
    $this->setDecoratorTemplate(false === $layout ? false : $layout.$this->getExtension());
